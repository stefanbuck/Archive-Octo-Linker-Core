...
module.exports = function(window, options) {
  ...
  var $intro = $('<div class="octo-linker-intro flash flash-notice"><span class="octicon octicon-x flash-close js-flash-close"></span>' + messageHTML + '</div>');
